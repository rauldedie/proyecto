    ...
    <div class="row g-2">
        ...
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="telefono" id="validationCustom05" placeholder="telefono">
                <div class="valid-feedback">
                    ¡Correcto!
                </div>
            </div>
    ...
    <div class="row g-2">
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="validationCustom09" name="urgencias1" placeholder="Telefono urgencias">               
