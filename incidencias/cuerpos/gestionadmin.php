<!-- Header -->
<?php include "../cuerpos/cabeceragestion.php"?>
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <?php
            ...
            while($row= mysqli_fetch_assoc($vista_incidencias)){
              ...
              //selecciono el aula
              $queryaula = printf("SELECT aula FROM aulas WHERE idaula=%i",$row['idaula']);
              $resultadoaula = mysqli_query($enlace,$queryaula); 
              //$filaaula = mysqli_fetch_array ($resultadoaula); 
              $aula=$resultadoaula;
              //seleciono la planta           
              $queryplanta = printf("SELECT planta FROM planta, aulas WHERE planta.idplanta=aulas.idplanta and idaula=%i",$row['idaula']);
              $resultadoplanta = mysqli_query($enlace,$queryplanta); 
              $planta = $resultadoplanta;        
...
<div class="container text-center mt-5">
    ...
    <div>
<?php include "../pie/piegestion.php" ?>